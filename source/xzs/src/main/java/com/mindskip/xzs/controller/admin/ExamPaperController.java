...
public class ExamPaperController extends BaseApiController {
    ...
    @Autowired
    public ExamPaperController(ExamPaperService examPaperService, AutoPaperService autoPaperService) {
        this.examPaperService = examPaperService;
        this.autoPaperService = autoPaperService;
    }

    @PostMapping("/auto-generate")
    public RestResponse<ExamPaperEditRequestVM> autoGenerate(
            @RequestBody @Valid AutoPaperGenerateRequestVM model) {
        return RestResponse.ok(autoPaperService.generate(model, getCurrentUser()));
    }
