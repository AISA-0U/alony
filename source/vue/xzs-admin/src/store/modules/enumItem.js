...
const state = {
  user: {
    ...
    levelEnum: [{ key: 1, value: '质量管理部' }, { key: 2, value: '通电测试部' }, { key: 3, value: '运维服务部' }, { key: 4, value: '电气技术' }, { key: 5, value: '结构技术' }, { key: 6, value: '电气成套厂' },
      { key: 7, value: '机柜制造厂' }, { key: 8, value: '仓储部' }, { key: 9, value: '采购部' },
      { key: 10, value: '项目管理部' }, { key: 11, value: '销售部' }, { key: 12, value: '信息部' }],
