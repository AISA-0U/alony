<template>
  <el-container>
    ...
    <el-footer height="340" class="student-footer">
      <div class="foot-container">
        <div class="footer-main">
          <h4>汉舟其他信息系统</h4>
          <a href="http://172.16.0.135:36588/#/login" target="_blank" class="footer-main-link">汉舟MOM系统</a>
          <a href="http://172.16.0.121:25499/k3cloud" target="_blank" class="footer-main-link">汉舟ERP系统</a>
          <a href="http://172.16.0.114:8050/" target="_blank" class="footer-main-link">汉舟PLM系统</a>
        </div>
        <!-- <div class="footer-main">
          <h4>微信小程序</h4>
        ...
        <div class="footer-main">
          ...
          <a href="https://www.haboat.com/" target="_blank" class="footer-main-link">汉舟电气官网</a>
        </div>
        <div class="footer-main">
          <h4>文档中心</h4>
          <a href="https://github.com/mindskip/xzs-mysql" target="_blank" class="footer-main-link">开源系统仓库地址</a>
    ...
    <div class="foot-copyright">
      <span>Copyright ©2026 四川汉舟电气股份有限公司 二次开发版权所有</span>
    </div>
  </el-container>
</template>
